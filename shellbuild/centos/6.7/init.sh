...
#step 2.0 update M4 firstly
wget -O "$PREFIX/$M4.tar.gz" https://ftp.gnu.org/gnu/m4/m4-1.4.16.tar.gz
mkdir -p "$PREFIX/$M4"
tar xzvf "$PREFIX/$M4.tar.gz" -C "$PREFIX/$M4" --strip-components=1 && cd "$PREFIX/$M4"
